...
async function main() {
    try {
        ...
        const results = await runGeneralSubcategoryAllocation(genStudents, 2);
        ...
        results.success.forEach(a => {
            ...
            const specialCriteria = a.subCategory === 'GNSPT' ? student.sptMarks : 
                                  a.subCategory === 'GNPWD' ? student.pwdRank :
                                  a.subCategory === 'GNCPF' || a.subCategory === 'GNCDP' ? student.cdpPriority : '';
        ...
        results.failures.forEach(f => {
            ...
            const prevAlloc = student?.allocations?.[0];
            const specialCriteria = student.subCategory === 'GNSPT' ? student.sptMarks : 
                                  student.subCategory === 'GNPWD' ? student.pwdRank :
                                  student.subCategory === 'GNCPF' || student.subCategory === 'GNCDP' ? student.cdpPriority : '';
